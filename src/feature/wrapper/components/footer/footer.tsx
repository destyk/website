...
const Footer = () => {
  return (
    <footer className={clsx(styles['footer'], 'mt-auto', 'pt-5')}>
      <ul className="nav pb-1 mb-1 justify-content-center">
        <li className="nav-item">
          <a
            ...
            rel="noreferrer">
            <BodyText className={clsx(styles['icon'], 'pe-1')}></BodyText>
        ...
        <li className="nav-item">
          <a
            ...
            className="nav-link px-3"
            rel="noreferrer">
            <Telegram className={clsx(styles['icon'], 'pe-1')}></Telegram>
        ...
        <li className="nav-item">
          <a
            ...
            className="nav-link px-3"
            rel="noreferrer">
            <Github className={clsx(styles['icon'], 'pe-1')}></Github>
        ...
        <li className="nav-item">
          <a
            ...
            className="nav-link px-3"
            rel="noreferrer">
            <HeartFill className={clsx(styles['icon'], 'text-danger', 'pe-1')}></HeartFill>
